        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Edit Admin Diaspora</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="time-table.html">Admin Diaspora</a></li>
                            <li class="breadcrumb-item active">Edit Admin Diaspora</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('user/update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>Edit Admin Diaspora</span></h5>
                                    </div>
