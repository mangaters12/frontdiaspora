                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ms-md-n2 profile-user-info">
                            ...
                            <div class="user-Location"><i class="fas fa-map-marker-alt"></i> Depok, West Java</div>
                            <div class="about-text">Masterbagasi</div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9">12 Mar 1999</p>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <p class="col-sm-9 mb-0">North Jakarta<br>
                                                Cilincing,<br>
                                                Kebantenan - 33165,<br>
                                                Indonesia.</p>
                                        </div>
